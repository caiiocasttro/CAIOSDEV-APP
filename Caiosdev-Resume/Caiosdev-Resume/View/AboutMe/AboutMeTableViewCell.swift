...
class AboutMeTableViewCell: UITableViewCell {
    ...
    private func configureLayout() {
        ...
        NSLayoutConstraint.activate([
            ...
            shadow.topAnchor.constraint(equalTo: cellTitle.bottomAnchor, constant: 5),
            shadow.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20),
            shadow.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20),
            shadow.bottomAnchor.constraint(equalTo: bottomAnchor, constant: -20),
